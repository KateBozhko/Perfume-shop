...
function Pictures() {
    ...
    <ul className="textOne">
        ...
        <li><img src="https://img.icons8.com/emoji/1x/crown-emoji.png" alt="crown" width="20px"/>5 years on the market</li>
    </ul>
    </div>
    <div className="one">
    ...
    <ul className="textOne">
        ...
        <li><img src="https://img.icons8.com/emoji/1x/crown-emoji.png" alt="crown" width="20px"/>Individual approach</li>
    </ul>
    </div>
</div>
...
<div className="item">
    <img src="https://icons8.com/preloaders/preloaders/786/Flat%20hourglass.gif" alt="icon" width="50px" height="50px"/>
    <p>Persistent<br></br>odors</p>
</div>

<div className="item">
    <img src="https://icons8.com/preloaders/preloaders/162/Euro%20animated.gif" alt="icon" width="50px" height="50px"/>
    <p>European raw<br></br> material suppliers</p>
</div>
